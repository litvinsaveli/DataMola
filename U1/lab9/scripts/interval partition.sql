...
ALTER TABLE l9.calendar MOVE PARTITION PART_3
    TABLESPACE lab9_1 NOLOGGING COMPRESS;


ALTER TABLE l9.calendar SPLIT PARTITION PART_3
    AT (TO_DATE('10-05-2000', 'MM-DD-YYYY'))
    INTO(PARTITION PART_1, PARTITION PART_2);
    
ALTER TABLE l9.calendar TRUNCATE PARTITION PART_1;

ALTER TABLE l9.calendar drop PARTITION PART_1;
